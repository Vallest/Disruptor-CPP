...
extern "C" JNIEXPORT void JNICALL Java_com_disruptor_1cpp_tests_MainActivity_setAssetManager(JNIEnv* env, jobject obj, jobject assetManager)
{
    g_AAssetManager = AAssetManager_fromJava(env, assetManager);
}

extern "C" JNIEXPORT void JNICALL Java_com_disruptor_1cpp_tests_MainActivity_runTestCases(JNIEnv* env, jobject obj)
{
    g_JNIEnv = env;
    g_Object = obj;
